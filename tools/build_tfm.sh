...
cp BUILD/ARM_MUSCA_A1_S/$TOOLCHAIN/TARGET_PSA.bin $MBED_OS_ROOT/targets/TARGET_ARM_SSG/TARGET_MUSCA_A1/TARGET_MUSCA_A1_NS/device/tfm.bin
cp BUILD/ARM_MUSCA_A1_S/$TOOLCHAIN/cmse_lib.o $MBED_OS_ROOT/targets/TARGET_ARM_SSG/TARGET_MUSCA_A1/TARGET_MUSCA_A1_NS/device/cmse_lib.o
